...
namespace Marketplace.Dal
{
    ...
    public class MarketplaceContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder options) => options.UseSqlServer("Server=DESKTOP-FS8HF8N;Database=Marketplace;Trusted_Connection=True;MultipleActiveResultSets=true");
